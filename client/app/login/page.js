            ...
            <div className="w-full max-w-[1060px] m-0 p-3 flex justify-center gap-8 items-center" >
                <form className="flex-1 flex items-center flex-col gap-3 rounded-md bg-white lg:max-w-[600px] py-2" onSubmit={handleSubmit}>
                    <div className="flex w-[80%] p-2 pl-0 flex-col">
                        <h1 className="text-3xl text-start p-0 m-0 font-extrabold">Sign In</h1>
                    ...
                    <div className="flex w-[80%] gap-2 my-2 justify-between items-center">
                        <Link href="/register" className="flex flex-col">
                            <button className="bg-[#e6e0e0] text-gray-700 rounded-full sm:px-6 px-3 py-2 font-candara">Create Account?</button>
                        </Link>
                        <div className="flex flex-col">
                            <button className="bg-blue-500 text-white rounded-md sm:px-6 px-3 py-2 font-candara">Sign In</button>
                        </div>
                    </div>
