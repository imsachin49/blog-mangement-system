        ...
        <div className="w-full m-0 p-0 flex justify-center items-center">
            <div className="w-full max-w-[1100px] m-0 p-3 flex justify-between items-center px-6">
                ...
                <div className="xs:hidden md:flex justify-between items-center gap-7">
                    ...
                    <Link href="/blog/5467" className="cursor-pointer text-[#183B56] hover:text-[#1576DB]">Article</Link>
                    <Link href="/profile/5467" className="cursor-pointer text-[#183B56] hover:text-[#1576DB] flex items-center justify-center">Profile<BiChevronDown /></Link>
